        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    ...
                    <?php
                    if (moduleIsEnabled('reception') && 1==2) {
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'live_class') echo 'nav-expanded nav-active';?> d-none">
                        <a>
                    ...
                    if (moduleIsEnabled('attachments_book')) {
                        ...
                        ?>
                    <!-- attachments upload -->
                    <li class="nav-parent <?php if ($main_menu == 'attachments') echo 'nav-expanded nav-active';?> d-none">
                        <a>
                    ...
                    ?>
                    <!-- attachments upload -->
                    <li class="nav-parent <?php if ($main_menu == 'homework') echo 'nav-expanded nav-active';?> d-none">
                        <a>
                    ...
                    if (moduleIsEnabled('online_exam')) {
                        ...
                        ?>
                    <li class="nav-parent <?php if ($main_menu == 'onlineexam') echo 'nav-expanded nav-active';?> d-none">
                        <a>
                    ...
                    ?>
                    <!-- supervision -->
                    <li class="nav-parent <?php if ($main_menu == 'hostels' || $main_menu == 'transport') echo 'nav-expanded nav-active';?> d-none">
                        <a>
                    ...
                    ?>
                    <!-- library -->
                    <li class="nav-parent <?php if ($main_menu == 'library') echo 'nav-expanded nav-active';?> d-none">
                        <a>
                    ...
                    if (moduleIsEnabled('events')) {
                        ...
                        ?>
                    <!-- envant -->
                    <li class="nav-parent <?php if ($main_menu == 'event') echo 'nav-expanded nav-active';?> d-none">
                        <a>
                    ...
                    if (moduleIsEnabled('student_accounting')) {
                        ...
                        ?>
                    <!-- student accounting -->
                    <li class="nav-parent <?php if ($main_menu == 'fees' || $main_menu == 'offline_payments') echo 'nav-expanded nav-active';?> d-none">
                        <a>
                    ...
                    if (moduleIsEnabled('office_accounting')) {
                        ...
                        ?>
                    <!-- office accounting -->
                    <li class="nav-parent <?php if ($main_menu == 'accounting') echo 'nav-expanded nav-active';?> d-none">
                        <a>
                    ...
                    <?php }} ?>
                    <!-- message -->
                    <li class="<?php if ($main_menu == 'message') echo 'nav-active';?> d-none">
