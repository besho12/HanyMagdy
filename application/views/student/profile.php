				...
				<div id="profile" class="accordion-body collapse <?=($this->session->flashdata('profile_tab') == 1 ? 'in' : ''); ?>">
					...
					<div class="panel-body">
						...
						<div class="row">
							...
							<div class="col-md-4 mb-sm d-none">
								<div class="form-group">
						...
						<div class="row">
							<div class="col-md-6 mb-sm d-none">
								<div class="form-group">
                            ...
                            <div class="col-md-6 mb-sm">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fas fa-user-graduate"></i></span>
                                        <input type="text" class="form-control" name="school" value="<?=set_value('school', $student['school'])?>" />
                                    </div>
                            ...
                            <div class="col-md-6 mb-sm">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fas fa-user-graduate"></i></span>
                                        <input type="text" class="form-control" name="center" value="<?=set_value('center', $student['center'])?>" />
                                    </div>
                                    <span class="error"></span>
                                </div>
						...
						<div class="row">
                            ...
                            <div class="col-md-3 mb-sm">
                                <div class="form-group">
                                    <label class="control-label"><?='Parent ' . translate('mobile_no')?> <span class="required">*</span></label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fas fa-phone-volume"></i></span>
                                        <input type="text" class="form-control" name="parent_mobileno" value="<?=set_value('parent_mobileno', $student['parent_mobileno'])?>" />
                                    </div>
                                    <span class="error"><?=form_error('parent_mobileno')?></span>
                                </div>
                            </div>
                            <div class="col-md-12 mb-sm">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fas fa-phone-volume"></i></span>
										<textarea class="form-control" name="notes"><?=set_value('notes', $student['notes'])?></textarea>
                                    </div>
                                    <span class="error"><?=form_error('notes')?></span>
                                </div>
                            </div>
							<div class="col-md-3 mb-sm d-none">
								<div class="form-group">
