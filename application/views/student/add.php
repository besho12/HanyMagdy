		...
		<section class="panel">
			...
			<div class="panel-body">
				...
				<div class="row">
					...
					<div class="col-md-<?php echo $div ?> mb-sm">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="register_no" value="<?=set_value('register_no')?>" />
							<span class="error"></span>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-<?php echo $div ?> mb-sm d-none">
						<div class="form-group">
                    ...
                    <div class="col-md-<?php echo $div ?> mb-sm">
                        <div class="form-group">
                            <label class="control-label"> <?='School'?><?php echo $last_name['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fas fa-user-graduate"></i></span>
                                <input type="text" class="form-control" name="school" value="<?=set_value('school')?>" />
                            </div>
                            <span class="error"></span>
                        </div>
                        <span class="error"><?=form_error('school')?></span>
                    </div>
                    <div class="col-md-<?php echo $div ?> mb-sm">
                        <div class="form-group">
                            <label class="control-label"> <?='Center'?><?php echo $last_name['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fas fa-user-graduate"></i></span>
                                <input type="text" class="form-control" name="center" value="<?=set_value('center')?>" />
                            </div>
                            <span class="error"></span>
                        </div>
                        <span class="error"><?=form_error('center')?></span>
                    </div>
				...
				<div class="row">
					...
					<div class="col-md-<?php echo $div ?> mb-sm">
                        ...
                        <div class="col-md-<?php echo $div ?> mb-sm">
                            <div class="form-group">
                                <label class="control-label"><?='Parent '.translate('mobile_no')?><?php echo $student_mobile_no['required'] == 1 ? ' <span class="required">*</span>' : ''; ?></label>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fas fa-phone-volume"></i></span>
                                    <input type="text" class="form-control" name="parent_mobileno" value="<?=set_value('parent_mobileno')?>" />
                                </div>
                                <span class="error"></span>
                            </div>
                        </div>
						...
						<div class="col-md-12 mb-sm">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<textarea class="form-control"  name="notes" id="notes"> <?=set_value('notes')?> </textarea>
								</div>
								<span class="error"></span>
							</div>
						</div>
				...
				<div class="row">
					...
					?>
					<div class="col-md-12 mb-sm d-none">
						<div class="form-group">
				...
				<div class="<?=$getBranch['stu_generate'] == 1 || $getBranch['stu_generate'] == "" ? 'hidden-div' : '' ?> d-none" id="stuLogin">
					<!-- login details -->
					<div class="headers-line mt-md">
					...
					<div class="row mb-md">
						<div class="col-md-6 mb-sm">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control" name="username" id="username" value="<?='student'.time().random_int(1000, 9999).'@gmail.com'?>" />
								</div>
						...
						<div class="col-md-3 mb-sm">
							<div class="form-group">
								...
								<div class="input-group">
									<span class="input-group-addon"><i class="fas fa-unlock-alt"></i></span>
									<input type="password" class="form-control" name="retype_password" value="<?='12345678#$'?>" />
								</div>
				...
				<?php if (moduleIsEnabled('transport') && 1 == 0) { ?>
				<!-- transport details -->
				<div class="headers-line  mt-md">
				...
				<?php } ?>
				<?php if (moduleIsEnabled('hostel') && 1 == 0) { ?>
				<!-- hostel details -->
				<div class="headers-line">
