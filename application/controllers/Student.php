...
class Student extends Admin_Controller
{
    ...
    public function save() {
        if ($_POST) {
            ...
            if (!isset($_POST['guardian_chk']) && 1 == 0) {
                ...
                if ($csv_array) {
                    ...
                    foreach ($csv_array as $row) {
                        ...
                        if (count($csv_chk) <= 0) {
                            ...
                            $r = $this->csvCheckExistsData(time().random_int(1000, 9999), $row['Roll'], time().random_int(1000, 9999), $classID, $sectionID, $branchID, $unique_roll);
                            if ($r['status'] == false) {
    ...
    {
        $this->load->helper('download');
        $data = file_get_contents('uploads/multi_student_sample2.csv');
